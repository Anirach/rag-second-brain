...
% Version 13 - Revised with expanded related work and experimental validation
% February 2026
...
\begin{itemize}
    ...
    \item \textbf{BM25:} Lexical retrieval as a co-occurrence proxy. BM25's term-frequency and inverse-document-frequency weighting captures similar term association patterns as PPMI while being more practical to implement and tune. Prior work shows BM25 and PPMI-based methods exhibit similar retrieval characteristics for lexical matching \citep{manning2008introduction}.
