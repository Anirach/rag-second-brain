% NCD-CIE v7 — Added Framingham outcome-based validation
...
NCD-CIE achieved AUC-ROC\,=\,0.721 [95\% CI: 0.700--0.741] and
...
[$-$0.12 to $-$0.04], indicating well-calibrated risk estimates
...
${\sim}$0.75~\cite{dagostino2008framingham}, which was \emph{fit} to
...
risk modelling.  The NRI of $+$0.213 further supports the clinical
...
Sex-stratified coefficients from Table~3.
