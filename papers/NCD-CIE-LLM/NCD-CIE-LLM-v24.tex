% NCD-CIE v24 — Final revision: Causal forest HTE literature + reviewer fixes (Feb 2026)
...
yielded $\rho = 0.80$ (95\% CI: $-$0.30--0.99, $n = 4$), confirming
concordance extends to trials not used in parameter tuning, though
the wide CI reflects limited subgroup count.
...
The held-out FOURIER subgroups alone yield $\rho = 0.80$, though
the wide CI ($-$0.30--0.99) reflects the limited sample of 4
subgroups.
